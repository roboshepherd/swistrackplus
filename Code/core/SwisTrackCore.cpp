...
THISCLASS::SwisTrackCore(wxString componentconfigurationfolder):
		...
		mDataStructureInputShopFloor(wxT("ShopFloor"), wxT("ShopFloor")),
		mDataStructureRobotDevices(),
		mDataStructureShopTasks(),
  ...
  mAvailableComponents.push_back(new ComponentInputShopFloorLayout(this));
  ...
  mAvailableComponents.push_back(new ComponentDBusServer(this));
	...
	mDataStructures.push_back(&mDataStructureInputShopFloor);
	mDataStructures.push_back(&mDataStructureRobotDevices);
	mDataStructures.push_back(&mDataStructureShopTasks);
}
