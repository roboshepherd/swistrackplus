...
public:
	...
	DataStructureInputShopFloor mDataStructureInputShopFloor;
    DataStructureRobotDevices mDataStructureRobotDevices;
     DataStructureShopTasks mDataStructureShopTasks;
